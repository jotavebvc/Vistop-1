  ...
  return (
    <div className="rota-escolhida">
      ...
      <Container>
        ...
        <span className="rota-escolhida-endereço">
          <small>avenida b manuel, 10211</small>
        </span>
      </Container>
      <img
        src={imagemMaps}
        alt="imagem do google maps"
        className="imagemMaps"
      />
      <div className="my-button">
        <Button>
          Abrir no Google Maps{" "}
          <AddLocationAltIcon className="icon-interno" fontSize="large" />
        </Button>
      </div>
        ...
        <TouchableOpacity onPress={goToProcessos}>
          <div className="list2">
            <div className="list-text">
              <span>
                <strong>Cheguei ao destino!</strong>
              </span>
            </div>
